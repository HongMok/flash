...
if(id != "" && id != null)
{
	...
	item.linkageClassName = "mmo.magiczoo.animalfollow.Animal"+id+"_Back";
}
renameAnimal();
...
if(id != "" && id != null)
{
	...
	item.name = animalName;
	item.linkageClassName = "mmo.magiczoo.animalfollow.Animal"+id+"_Front";
}
renameAnimal();
var filePath = "file:///D|/vstsworkspace/mmo/source/assets/magiczoo/animal"+id+".fla";
